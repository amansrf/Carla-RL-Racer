...
from ROAR_gym.ppo_util import find_latest_model, CustomMaxPoolCNN, Atari_PPO_Adapted_CNN
...
class RLe2ePPOEvalAgent(Agent):
    ...
    def __init__(self, vehicle: Vehicle, agent_settings: AgentConfig, **kwargs):
        ...
        self.model_path = "C:/Users/micha/Desktop/rl_model_17204562_steps"
        print(self.model_path)

        self.model = PPO.load(Path("C:/Users/micha/Desktop/ROAR_MEng/ROAR/ROAR_gym/output/PPOe2e_Run_5/logs/rl_model_17275983_steps.zip"), policy_kwargs = policy_kwargs)
